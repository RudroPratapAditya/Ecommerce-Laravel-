...
<ul class="breadcrumb">
			...
			<a href="{{url('all-pending-order')}}" class="btn btn-lg btn-block btn-success" >All Pending Orders</a>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>All Confirmed Orders</h2>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable">
						 ...
						 @foreach($all_confirmed_order as $v_order)
						  <tbody>
							<tr>

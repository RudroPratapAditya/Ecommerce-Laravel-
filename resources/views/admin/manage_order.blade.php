...
<ul class="breadcrumb">
						 ...
						 @foreach($all_order_info as $v_order)
						  <tbody>
							<tr>
								...
								<td class="center">{{$v_order->customer_first_name}}</td>
								<td class="center">{{$v_order->customer_last_name}}</td>
 ...
 --}}
								<td class="center">
									...
									<a class="btn btn-danger" href="{{URL::to('/inactive/'.$v_order->order_id)}}">

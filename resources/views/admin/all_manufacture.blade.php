...
<ul class="breadcrumb">
			...
			<a href="{{route('admin.add-manufacture')}}" class="btn btn-lg btn-block btn-warning" >Add Manufacture</a>
						 ...
						 @foreach($all_manufacture_info as $v_manufacture)
						  <tbody>
							<tr>
								...
								<td class="center">
									@if($v_manufacture->publication_status==1)
									<a class="btn btn-danger" href="{{URL::to('/inactive_manufacture/'.$v_manufacture->manufacture_id)}}">
